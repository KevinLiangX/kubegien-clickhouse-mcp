...
class ClickHouseConfig:
    ...
    Optional environment variables (with defaults):
        ...
        CLICKHOUSE_HUARUN_CONTEXT: Huarun context for ClickHouse server (default: false)
    """
    ...
    @property
    def huarun_context(self) -> bool:
        """Get whether ClickHouse server HuaRun Context is enabled.

        Default: False
        """
        return os.getenv("CLICKHOUSE_HUARUN_CONTEXT", "false").lower() == "true"
